...
const papers = [
  {
    year: "2025",
    title: "NFL Previous Year Paper 2025",
    description: "NFL recruitment exam previous year question paper.",
  },
  {
    year: "2024",
    title: "NFL Previous Year Paper 2024",
    description: "NFL recruitment exam previous year question paper.",
  },
  {
    year: "2023",
    title: "NFL Previous Year Paper 2023",
    description: "NFL recruitment exam previous year question paper.",
  },
  {
    year: "2022",
    title: "NFL Previous Year Paper 2022",
    description: "NFL recruitment exam previous year question paper.",
  },
];

export default function NFLPreviousYearPage() {
  return (
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10">
          ...
          <h1 className="mt-3 text-4xl font-black md:text-6xl">
            NFL Previous Year Papers
          </h1>

          <p className="mt-4 max-w-2xl text-lg text-slate-300">
            NFL previous year question papers will be available soon.
          </p>
        </div>
